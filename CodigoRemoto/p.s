...
nombre_buffer: .int 50                              // Buffer para el nombre
palabra_prompt: .asciz "Introduce una palabra: "       
len_palabra_prompt: .int 28                            
palabra_buffer: .int 20                              // Buffer para almacenar la palabra ingresada
...
palabra_elegida: .int 20                              // Buffer para almacenar la palabra elegida
...
main:
    ...
    ldr r2, =20                             // Longitud de la palabra (ajusta si es necesario)
...
sortear_palabra:
    ...
    lsl r3, r3, #4                          // Multiplicar por 16 (ajusta esto según la longitud de tus palabras)
